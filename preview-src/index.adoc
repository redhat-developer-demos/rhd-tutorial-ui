...
This is a command
with multiple lines
so we can test the copy to clipboard button
----
...
[.console-input]
----
Block, but no source identification
----

[.console-input]
[source,bash]
----
Single long command to test if the copy to clipboard button is covering some of the text.
----
